...
if __name__ == '__main__':
    ...
    parser.add_argument('base_model_name', type=str, help='path_to_base_model')
    ...
    for data in to_eval_on:
        ...
        for subdataset_name in data['subdataset_names']:
            ...
            responses = vllm_model.generate(prompts, sampling_params, lora_request=LoRARequest("LLaMA3-70B-SLIMER-ADAPTER", 1, args.path_to_LORA))
            ...
            model_name = args.base_model_name.split('/')[-1] + '_' + args.path_to_LORA.split('/')[-1]
            path_to_save_predictions = os.path.join("./predictions", model_name)
